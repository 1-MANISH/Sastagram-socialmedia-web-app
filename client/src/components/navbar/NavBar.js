...
import { disconnectSocket, setIsLoggedIn, setMyFollowSuggestionEmpty, setMyProfileEmpty, subscribeToFollowRequest, unsubscribeToFollowRequest, } from '../../redux/slices/appConfigSlice'
...
function NavBar() {
        ...
        useEffect(()=>{
                dispatch(subscribeToFollowRequest())

                return ()=> dispatch(unsubscribeToFollowRequest())
        },[subscribeToFollowRequest,unsubscribeToFollowRequest])
